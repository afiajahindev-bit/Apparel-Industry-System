                ...
                <form action="bkash.php" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="mb-2">
                                <label for="number" class="form-label">bKash Number</label>
                            ...
                            <div>
                                <div class="d-flex align-items-center">
                                    <div style="width:10%;"><img src="images/bkash.png" alt="" class="img-fluid rounded-3"></div>
                                    <div>
                        ...
                        <div class="col">
                            <div class="mt-1" style="width:90%">
                                ...
                                <ol>
                                    <li>Visit bKash App</li>
                                    <li>Go to 'Make Payment' option</li>
                                    <li>Enter Merchant number '01878-726339'</li>
                                    <li>Enter the total amount</li>
                                    <li>Add the given reference number</li>
                                    <li>Complete your payment</li>
                                    <li>Return to this page and Enter your bKash Transaction ID</li>
